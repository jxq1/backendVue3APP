    ...
    <el-col :span="16" style="margin-top: 20px">
      ...
      <div class="graph">
        <el-card style="height: 260px">
          <div ref="userechart" class="userechart" style="height: 240px"></div>
        </el-card>
        <el-card style="height: 260px">
...
export default defineComponent({
  setup() {
    ...
    const getTableList = async () => {
      //   await axios.get('https://www.fastmock.site/mock/02f9ad5325caf30d39c4fba567b1c76f/api/home/getData').then((res)=>{
      //       console.log(res)
    ...
    const getChartData = async () => {
      ...
      console.log(xOptions, "xoptions2");
